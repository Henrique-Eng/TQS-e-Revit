...
clr.AddReference('DSCoreNodes')
from DSCore import ImportExport as ImportExportNodes
...
#ImportExport from Dynamo Library Nodes - Revit
clr.AddReference("RevitNodes")
import ImportExport as ImportExportNodes
...
try:
    ...
    # Your Code Here
    # Get all .DXF's (Structural columns shop drawings) in the directory
    result = FileSystem.DirectoryFromPath(Path_directory_string)
